...
dizinine `.crt` uzantılı sertifika dosyanızı kopyalayın ve build komutunu tekrar
çalıştırın:
...
sertifikalar deposuna eklenir. Sertifika dosyanız değiştiğinde veya yeni bir sertifika
eklediğinizde imajı yeniden oluşturmanız yeterlidir.
...
## Örnek CSV Şablonu
```
type,budget_code,budget_name,map_attribute,capex_opex,asset_type,scenario,year,month,amount,date,quantity,unit_price,vendor,description,out_of_budget
plan,MARKETING,Marketing Temel,Hizmet,OPEX,Hizmet,Temel,2024,1,15000,,,,,
